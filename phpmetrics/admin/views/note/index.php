                ...
                <div class="col-sm-5 col-md-5">
                    <div class="thumbnail">
                        ...
                        <div class="caption text-center"
                             onclick="location.href='<?= Url::to(['note/update', 'idNotes' => $userNote['idNotes']]); ?>'">
                            <h4 class="thumbnail-label"><?=$userNote['nameNote']?></h4>

                            <div class="thumbnail-description smaller size">
                                <?
